...
1. 打开 Chrome 浏览器，点击右上角的图标，进入扩展程序管理界面。
2. 在弹出的菜单中点击“扩展程序”，然后选择“管理扩展程序”。
3. 开启右上角的“开发者模式”，点击“加载已解压的扩展程序”，选择 `chrome-adaptgen` 所在文件夹并加载。
...
在题目描述界面点击插件主界面中的 **Generate** 或通过右键菜单选择生成模板。
